...
## Add argument completer for the dotnet CLI tool if dotnet is installed
$scriptblock = {
...
Get-Command -Name dotnet -ErrorAction SilentlyContinue -ErrorVariable dotnet_err -OutVariable dotnet_out > $null
if ($?) {
